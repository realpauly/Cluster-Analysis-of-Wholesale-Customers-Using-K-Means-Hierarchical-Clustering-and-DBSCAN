...
**Cluster 3 (Low-frequency or niche buyers):** Especially visible in DBSCAN, this group may contain outliers or low-frequency buyers with irregular spending habits. Personalized outreach or re-engagement strategies could be effective for this group. Noise Points (Outliers): Identified by DBSCAN, these points represent unusual spending patterns that do not fit well into any main segment. Further analysis may reveal unique needs or occasional buyers, who could benefit from personalized offers or limited-time discounts.
